...
export const CPU_OP_RESOLVE_RULES: ReadonlyArray<OpSet.ResolveRule> = [
  ...
  ['Acos', '', '7+', () => new CpuUnaryOp(NUMBER_TYPES, unaryOps.acos)],
  ['Add', '', '7+', () => new CpuBinaryOp(NUMBER_TYPES, (e1, e2) => (e1 + e2))],
  ['And', '', '7+', () => new CpuBinaryOp(['bool'], (e1, e2) => (e1 && e2))],
  ['ArgMax', '', '1+', () => new CpuArgMax()],
  ['Asin', '', '7+', () => new CpuUnaryOp(NUMBER_TYPES, unaryOps.asin)],
  ['Atan', '', '7+', () => new CpuUnaryOp(NUMBER_TYPES, unaryOps.atan)],
  ...
  ['Ceil', '', '6+', () => new CpuUnaryOp(NUMBER_TYPES, unaryOps.ceil)],
  ['Clip', '', '6+', () => new CpuUnaryOp(FLOAT_TYPES, unaryOps.clip, unaryOps.clipInitializer)],
  ['Concat', '', '4+', () => new CpuConcat()],
  ['Conv', '', '1+', () => new CpuConv()],
  ['Cos', '', '7+', () => new CpuUnaryOp(NUMBER_TYPES, unaryOps.cos)],
  ...
  ['Exp', '', '6+', () => new CpuUnaryOp(NUMBER_TYPES, unaryOps.exp)],
  ['Flatten', '', '1+', () => new CpuFlatten()],
  ['Floor', '', '6+', () => new CpuUnaryOp(NUMBER_TYPES, unaryOps.floor)],
  ...
  ['Log', '', '6+', () => new CpuUnaryOp(NUMBER_TYPES, unaryOps.log)],
  ['LRN', '', '1+', () => new CpuLrn()],
  ...
  ['Relu', '', '6+', () => new CpuUnaryOp(NUMBER_TYPES, unaryOps.relu)],
  ['Reshape', '', '5+', () => new CpuReshape()],
  ['Sigmoid', '', '6+', () => new CpuUnaryOp(NUMBER_TYPES, unaryOps.sigmoid)],
  ['Sin', '', '7+', () => new CpuUnaryOp(NUMBER_TYPES, unaryOps.sin)],
  ['Slice', '', '1+', () => new CpuSlice()],
  ['Softmax', '', '1+', () => new CpuSoftmax()],
  ['Sqrt', '', '6+', () => new CpuUnaryOp(NUMBER_TYPES, unaryOps.sqrt)],
  ...
  ['Tan', '', '7+', () => new CpuUnaryOp(NUMBER_TYPES, unaryOps.tan)],
  ['Tanh', '', '6+', () => new CpuUnaryOp(NUMBER_TYPES, unaryOps.tanh)],
  ['Tile', '', '6+', () => new CpuTile()],
