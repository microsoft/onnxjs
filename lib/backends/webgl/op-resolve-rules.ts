...
import {WebGLResizePacked} from './ops/resize-bilinear-packed';
...
export const WEBGL_OP_RESOLVE_RULES: ReadonlyArray<OpSet.ResolveRule> = [
  ...
  // ['ResizeBilinearPacked', '', '1+', () => new WebGLResizePacked()],
  ['ResizePacked', '', '10', () => new WebGLResizePacked(10)],
  ['ResizePacked', '', '11+', () => new WebGLResizePacked(11)],
