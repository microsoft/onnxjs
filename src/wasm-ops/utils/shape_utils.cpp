...
std::vector<int32_t> ShapeUtils::compute_strides(const std::vector<int32_t> &dims) {
	auto rank = static_cast<size_t>(dims.size());
...
size_t ShapeUtils::indices_to_offset(const std::vector<int32_t> &strides, const std::vector<int> indices) {
...
std::vector<int> ShapeUtils::offset_to_indices(const std::vector<int> &strides, size_t offset) {
