...
https.get('https://raw.githubusercontent.com/onnx/onnx/master/onnx/defs/operator_sets.h', res => {
  ...
  rl.on('close', () => {
    ...
    doc.write('## Operators Support Table\n\n');
  ...
  ONNX.js currently support opset version 4 to 6, 8 and above.\n\n');
    doc.write('See [Compatibility](../README.md#Compatibility) for a list of the supported platforms.\n\n');
    doc.write('*This file is automatically generated from the\
  def files via [this script](/tools/gen-doc.ts).\
  Do not modify directly.*\n\n');
    doc.write('| Operator | Cpu Backend | Wasm Backend | WebGl Backend |\n');
    doc.write('|:--------:|:-----------:|:------------:|:-------------:|\n');
    ...
    for (const type of opTypes) {
      ...
      doc.write(`| [${type}](https://github.com/onnx/onnx/blob/master/docs/Operators.md#${type}) | ${
          ...
          webgl.filter(d => d.length > 0).join(', ')} |\n`);
    }
    doc.end();
  });
});
